...
use EP\Library\CloudServices\AliYun\OSS\Core\MimeTypes;
use EP\Library\CloudServices\AliYun\OSS\Core\OssException;
use EP\Library\CloudServices\AliYun\OSS\Http\RequestCore;
use EP\Library\CloudServices\AliYun\OSS\Http\RequestCore_Exception;
use EP\Library\CloudServices\AliYun\OSS\Http\ResponseCore;
use EP\Library\CloudServices\AliYun\OSS\Model\CorsConfig;
use EP\Library\CloudServices\AliYun\OSS\Model\CnameConfig;
use EP\Library\CloudServices\AliYun\OSS\Model\LoggingConfig;
use EP\Library\CloudServices\AliYun\OSS\Model\LiveChannelConfig;
...
use EP\Library\CloudServices\AliYun\OSS\Model\StorageCapacityConfig;
use EP\Library\CloudServices\AliYun\OSS\Result\AclResult;
use EP\Library\CloudServices\AliYun\OSS\Result\BodyResult;
use EP\Library\CloudServices\AliYun\OSS\Result\GetCorsResult;
use EP\Library\CloudServices\AliYun\OSS\Result\GetLifecycleResult;
use EP\Library\CloudServices\AliYun\OSS\Result\GetLocationResult;
use EP\Library\CloudServices\AliYun\OSS\Result\GetLoggingResult;
use EP\Library\CloudServices\AliYun\OSS\Result\GetRefererResult;
use EP\Library\CloudServices\AliYun\OSS\Result\GetStorageCapacityResult;
use EP\Library\CloudServices\AliYun\OSS\Result\GetWebsiteResult;
use EP\Library\CloudServices\AliYun\OSS\Result\GetCnameResult;
use EP\Library\CloudServices\AliYun\OSS\Result\HeaderResult;
use EP\Library\CloudServices\AliYun\OSS\Result\InitiateMultipartUploadResult;
use EP\Library\CloudServices\AliYun\OSS\Result\ListBucketsResult;
use EP\Library\CloudServices\AliYun\OSS\Result\ListMultipartUploadResult;
use EP\Library\CloudServices\AliYun\OSS\Model\ListMultipartUploadInfo;
use EP\Library\CloudServices\AliYun\OSS\Result\ListObjectsResult;
use EP\Library\CloudServices\AliYun\OSS\Result\ListPartsResult;
use EP\Library\CloudServices\AliYun\OSS\Result\PutSetDeleteResult;
use EP\Library\CloudServices\AliYun\OSS\Result\DeleteObjectsResult;
use EP\Library\CloudServices\AliYun\OSS\Result\CopyObjectResult;
use EP\Library\CloudServices\AliYun\OSS\Result\CallbackResult;
use EP\Library\CloudServices\AliYun\OSS\Result\ExistResult;
use EP\Library\CloudServices\AliYun\OSS\Result\PutLiveChannelResult;
use EP\Library\CloudServices\AliYun\OSS\Result\GetLiveChannelHistoryResult;
use EP\Library\CloudServices\AliYun\OSS\Result\GetLiveChannelInfoResult;
use EP\Library\CloudServices\AliYun\OSS\Result\GetLiveChannelStatusResult;
use EP\Library\CloudServices\AliYun\OSS\Result\ListLiveChannelResult;
use EP\Library\CloudServices\AliYun\OSS\Result\AppendResult;
use EP\Library\CloudServices\AliYun\OSS\Model\ObjectListInfo;
use EP\Library\CloudServices\AliYun\OSS\Result\SymlinkResult;
use EP\Library\CloudServices\AliYun\OSS\Result\UploadPartResult;
...
use EP\Library\CloudServices\AliYun\OSS\Model\RefererConfig;
use EP\Library\CloudServices\AliYun\OSS\Model\WebsiteConfig;
use EP\Library\CloudServices\AliYun\OSS\Core\OssUtil;
use EP\Library\CloudServices\AliYun\OSS\Model\ListPartsInfo;
use EP\Library\CloudServices\AliYun\OSS\Result\GetBucketInfoResult;
use EP\Library\CloudServices\AliYun\OSS\Model\BucketStat;
use EP\Library\CloudServices\AliYun\OSS\Result\GetBucketStatResult;
use EP\Library\CloudServices\AliYun\OSS\Model\ServerSideEncryptionConfig;
use EP\Library\CloudServices\AliYun\OSS\Result\GetBucketEncryptionResult;
use EP\Library\CloudServices\AliYun\OSS\Model\RequestPaymentConfig;
use EP\Library\CloudServices\AliYun\OSS\Result\GetBucketRequestPaymentResult;
use EP\Library\CloudServices\AliYun\OSS\Model\Tag;
use EP\Library\CloudServices\AliYun\OSS\Model\TaggingConfig;
use EP\Library\CloudServices\AliYun\OSS\Result\GetBucketTagsResult;
use EP\Library\CloudServices\AliYun\OSS\Model\VersioningConfig;
use EP\Library\CloudServices\AliYun\OSS\Result\GetBucketVersioningResult;
use EP\Library\CloudServices\AliYun\OSS\Model\InitiateWormConfig;
use EP\Library\CloudServices\AliYun\OSS\Result\InitiateBucketWormResult;
use EP\Library\CloudServices\AliYun\OSS\Model\ExtendWormConfig;
use EP\Library\CloudServices\AliYun\OSS\Result\GetBucketWormResult;
use EP\Library\CloudServices\AliYun\OSS\Model\RestoreConfig;
use EP\Library\CloudServices\AliYun\OSS\Model\ObjectVersionListInfo;
use EP\Library\CloudServices\AliYun\OSS\Result\ListObjectVersionsResult;
use EP\Library\CloudServices\AliYun\OSS\Model\DeleteObjectInfo;
use EP\Library\CloudServices\AliYun\OSS\Model\DeletedObjectInfo;
use EP\Library\CloudServices\AliYun\OSS\Result\DeleteObjectVersionsResult;
...
class OssClient
{
     ...
     * @param array $options
     * @return string signed pushing streaming url
     */
